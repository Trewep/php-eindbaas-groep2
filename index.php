                            ...
                            <?php foreach ($users as $user) : ?>
                                ...
                                <?php if ($post['userId'] === $user['id']) : ?>
                                    <?php if ($user['profileImage'] === 'defaultAvatar') : ?>
                                        <div><img class="feedProfile" src="./assets/images/defaultAvatar.png" alt=""></div>
                                    <?php else : ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if (!empty($post['location'])) : ?>
                                            <a id="postLocation" href="index.php?location=<?php echo htmlspecialchars($post['location']) ?>"><?php echo  htmlspecialchars($post['location']) ?></a>
                                        <?php endif; ?>
